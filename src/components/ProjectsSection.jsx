...
const projects = [
  {
    ...
    description: "A Simple Movie app using React and Typescript.",
    image: "/projects/project1.png",
    tags: ["React", "Typescript", "TailwindCSS"],
    demoUrl: "#",
    githubUrl: "https://github.com/SuryakantaPatil/movie-app-task.git",
  },
  {
    id: 2,
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="text-center mt-12">
          <a
            ...
            target="_blank"
            href="https://github.com/SuryakantaPatil"
          >
